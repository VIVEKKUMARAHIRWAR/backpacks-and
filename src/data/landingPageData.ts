...
export const whyChooseUsData = {
    ...
    closing: "The result? Students return with portfolios, not just photographs—equipped with analytical skills that extend far beyond the tour."
};
...
export const impactData = {
    ...
    primaryCta: {
        text: "View Collaboration Models",
        href: "/collaborations"
    },
    secondaryCta: {
        text: "Get in Touch",
...
export const problemData = {
    ...
    content: [
        ...
        "Travel, when it happens, is frequently reduced to sightseeing—lacking the structured pedagogical framework needed to transform it into a meaningful learning experience.",
        "Backpacks & Blueprints bridges this gap by turning travel into an extension of the classroom."
    ],
    closing: "We don't just organize tours; we curate architectural learning experiences."
};
